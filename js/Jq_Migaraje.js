...
function declarar_botones(){
	$("#guardar_aparcamiento").click(almacenarplanta);
...
function almacenarplanta(){
	...
	pintagaraje.jpasillos=$("#filas").val();
	pintagaraje.jplantas=$("#columnas").val();
...
$(document).ready(function(){
	creaBDgaraje();
    $("#guardar_aparcamiento").click(function(){
		almacenarplanta();
	});
